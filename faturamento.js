...
function calcFaturamento(faturamentoDiario) {
...
const resultados = calcFaturamento(faturamentoDiario);
...
console.log(`Número de dias com faturamento superior à média mensal: ${resultados.diasAcimaMedia}`);
console.log(`Média mensal de faturamento: R$ ${resultados.mediaMensal.toFixed(2)}`);
